...
export default function ActivityForm ({activity: selectedActivity, closeForm, handleCreateOrEdit}: Props) : JSX.Element {
    ...
    return (
        <Segment clearing>
            <Form onSubmit={handleSubmit} autoComplte='off'>
