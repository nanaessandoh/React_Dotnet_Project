...
const ActivityDetailsHeader = ({ activity }: Props) => {
    const { updateAttendance } = useActivities(activity.activityId);
            ...
            <Box sx={{
                ...
                <Box>
                    ...
                    <Typography variant="subtitle2">
                        Hosted by <Link to={`/profiles/${activity.hostUserId}`} style={{ color: 'white', fontWeight: 'bold' }}>{activity.hostDisplayName}</Link>
                    </Typography>
                </Box>
                    ...
                    {activity.isHost ? (
                        <>
                            <StyledButton
                                ...
                                onClick={() => updateAttendance.mutate(activity.activityId)}
